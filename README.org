...
** Simulation
   ...
   4. Copy the contents of =slocum_glider_extctl_sim/example_gliders/bear= to
      ...
      #+end_src
   5. Clone [[https://github.com/Field-Robotics-Lab/glider_hybrid_whoi/]] to the
      same directory as this repo.

   Any time you make a change to the code (in this repo or =glider_hybrd_whoi=,
   run:

   1. Run =docker-compose build=.

   There are ways around this, but I haven't yet written them up.
